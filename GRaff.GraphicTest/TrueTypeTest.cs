...
namespace GRaff.GraphicTest
{
    ...
    class TrueTypeTest : GameElement
	{
		...
		public override void OnDraw()
		{
            ...
            Draw.Text("Bold text", _fontBold, FontAlignment.Center, Room.Current.Center + new Vector(0, 72), Colors.Red);
            Draw.Text("Italic text", _fontItalic, FontAlignment.Center, Room.Current.Center + new Vector(0, 108), Colors.Blue);
            Draw.Text("Bold and italic text", _fontBoldItalic, FontAlignment.Center, Room.Current.Center + new Vector(0, 144), Colors.Purple);
