...
#region Static calls
		...
		public static double Gaussian(double mean, double std) { return std * (Gaussian() + mean); }
...
#region System.Random calls
		...
		/// <param name="rnd">The System.Random to generate the numbers.</param>
		/// <returns>An integer greater than or equal to zero and less than System.Int32.MaxValue.</returns>
		public static int Integer(this Random rnd) { return rnd.Integer(); }
		...
		/// <param name="rnd">The System.Random to generate the numbers.</param>
		/// <returns>A standard normally distributed number.</returns>
		public static double Gaussian(this Random rnd) { return GMath.Sqrt(-2 * GMath.Log(rnd.Double())); }
		...
		/// <param name="rnd">The System.Random to generate the numbers.</param>
		/// <returns>Returns a random angle.</returns>
		public static Angle Angle(this Random rnd) { return GRaff.Angle.Deg(rnd.NextDouble() * 360.0); }
		...
		/// <param name="upperBound">The upper bound.</param>
		/// <returns>A random angle in the specified range.</returns>
		public static Angle Angle(this Random rnd, Angle lowerBound, Angle upperBound) { return GRaff.Angle.Deg(lowerBound.Degrees + rnd.NextDouble() * (upperBound - lowerBound).Degrees); }
