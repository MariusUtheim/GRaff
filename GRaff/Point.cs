...
namespace GRaff
{
	...
	/// </summary>
#warning If Points are stored in float format, they really should expose members as floats
	[StructLayout(LayoutKind.Sequential)]
	public struct Point
	{ /*C#6.0*/
		private float _x, _y;// = (float)x, _y = (float)y;
		...
		/// <returns>true if the x- and y-coordinates of the two GRaff.Point structures are equal.</returns>
